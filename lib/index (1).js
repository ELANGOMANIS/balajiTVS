   ...
   for (const empEntry of Object.entries(groupedEntries)) {
    ...
    if (empData.length >= 1) {
        ...
        if (empData.length === 1) {
            ...
            if (lunchOutTime.isBetween(moment('11:00:00', 'HH:mm:ss'), moment('17:00:00', 'HH:mm:ss'))) {
                remark = 'HD';
            } else if (lunchOutTime.isBetween(moment('17:00:00', 'HH:mm:ss'), moment('23:59:59', 'HH:mm:ss'))) {
                remark = 'P';
            }
...
function processNightShiftEntries(nightShiftEntries) {
  ...
  nightShiftEntries.forEach((entry, index) => {
    ...
    const processedEntry = {
      ...
      'remark': (chkin == '00:00:00' && chkout == '00:00:00') || (chkout == '00:00:00') || (chkin == '00:00:00') ? 'A':'P',
    };
